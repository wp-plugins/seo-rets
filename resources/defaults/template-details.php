<div class="sr-listing-pg">
    ...
    <div class="basic_info">
        ...
        <table>
            ...
            <tr>
                <td>City State & Zip:</td><td><?php echo $l->city?>, <?php echo $l->state?> <?php echo $l->zip?></td>
            </tr>
            <tr>
    ...
    <div class="additional_info">
        ...
        <ul>
            <li>Subdivision: <?php echo $l->subdivision?></li>
    ...
    <div id="map_canvas" style="width: <?php echo $map_width?>px; height: <?php echo $map_height?>px;"></div>
