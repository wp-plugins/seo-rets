		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-9 left-border-line">
				...
				<div class="row margin-top-15">
					...
					<div class="col-md-8 col-sm-8">
						<select id="cities" class="sr-formelement form-control" srfield="city" sroperator="=" multiple="">
							<option value="">All</option>
							<?php
							$cities = $sr->metadata->res->fields->city->values;
							sort($cities);
				...
				<div id="subd-none" class="row margin-top-15 disp-none">
					...
					<div class="col-md-8 col-sm-8">
						<input type="text" name="sd834" class="sr-formelement form-control" srfield="subdivision"
							   sroperator="LIKE" srloose=""/>
					</div>
				</div>
				<div class="row margin-top-15">
			...
			<div class="col-md-9 col-sm-9 left-border-line">
					...
					<div class="col-md-8 col-sm-8">
						<div class="row">
							...
							<div class="col-md-66 col-sm-6">
								<input type="text" name="f89d5" class="sr-formelement form-control" placeholder="Min:" srfield="price"
							...
							<div class="col-md-6 col-sm-6">
								<input type="text" name="pa3jv" class="sr-formelement form-control" placeholder="Max:" srfield="price"
									   sroperator="&lt;=" srtype="numeric" />
							</div>
						</div>
					</div>
				...
				<div class="row margin-top-15">
					...
					<div class="col-md-8 col-sm-8">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<input type="text" name="d844k" class="sr-formelement form-control" placeholder="Min:" srfield="bedrooms"
									   sroperator="&gt;=" srtype="numeric" />
							</div>
							<div class="col-md-6 col-sm-6">
								<input type="text" name="fd8j7" class="sr-formelement form-control" placeholder="Max:" srfield="bedrooms"
									   sroperator="&lt;=" srtype="numeric" />
							</div>
						</div>
					</div>
				...
				<div class="row margin-top-15">
					...
					<div class="col-md-8 col-sm-8">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<input type="text" name="df69d" class="sr-formelement form-control" placeholder="Min:" srfield="baths"
									   sroperator="&gt;=" srtype="numeric" />
							</div>
							<div class="col-md-6 col-sm-6">
								<input type="text" name="hg75n" class="sr-formelement form-control" placeholder="Max:" srfield="baths"
									   sroperator="&lt;=" srtype="numeric" />
							</div>
						</div>
					</div>
				...
				<div class="row margin-top-15">
					...
					<div class="col-md-8 col-sm-8">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<input type="text" name="8vfm3" class="sr-formelement form-control" placeholder="Min:" srfield="sqft"
									   sroperator="&gt;=" srtype="numeric" />
							</div>
							<div class="col-md-6 col-sm-6">
								<input type="text" name="pkf63" class="sr-formelement form-control" placeholder="Max:" srfield="sqft"
									   sroperator="&lt;=" srtype="numeric" />
							</div>
						</div>
					</div>
