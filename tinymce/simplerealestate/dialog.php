...
<head>
	...
	wp_enqueue_script('sr_tinymce-simplerealestate-dialog',$sr->tinymce_url.'simplerealestate/js/dialog.js',array( 'jquery' ));
	wp_print_scripts(array('sr_tinymce-simplerealestate-dialog'));

	wp_enqueue_style('sr_tinymce_simplerealestate_dialog',$sr->css_resources_dir.'tinymce/simplerealestate_dialog.css');
	wp_print_styles(array('sr_tinymce_simplerealestate_dialog'));
	?>
