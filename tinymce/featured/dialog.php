...
<head>
	...
	wp_enqueue_script('sr_tinymce-featured-dialog',$sr->tinymce_url.'featured/js/dialog.js',array( 'jquery' ));
	wp_print_scripts(array('sr_tinymce-featured-dialog'));

	wp_enqueue_style('sr_tinymce_featured_dialog',$sr->css_resources_dir.'tinymce/featured_dialog.css');
	wp_print_styles(array('sr_tinymce_featured_dialog'));
				...
				<tr>
					...
					<td>
						<select id="display-order-column">
							...
							<table width='100%'>
							<tr>
				<th><label for="number-to-display">How many properties would you like to feature</label></th>
				<td width='50px'><input type="text" id="number-to-display" value="3" /><br /></td>
				</tr>
				<tr>
