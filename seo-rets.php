...
*/
	...
	public function posts_filter( $posts ) {
		...
		$listAllowedMehods=array('details','overview','search',
	...
	public function get_listing_string( $l, $t ) { //$l = listing, $t = type
...
//			'));
    ...
    */
	...
	public function arr_to_hidden( $arr, $parents = array() ) { // Converts an associative array to a string of hidden fields
